...
class ClinicAppointmentController extends Controller
{
    ...
    public function bodychart(Request $request, $id)
    {
        ...
        return view('appointment::backend.clinic_appointment.appointment_bodychart', compact('module_action', 'appointment_id', 'patient_id', 'encounter_id'));
    }
    ...
    public function downloadPDF(Request $request)
    {
        ...
        if ($request->is('api/*')) {
            ...
            $pdf = PDF::loadView('appointment::backend.clinic_appointment.invoice', compact('data'))->setOptions(['defaultFont' => 'sans-serif']);
