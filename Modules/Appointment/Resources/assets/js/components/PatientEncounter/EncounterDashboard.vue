<template>
   <form @submit.prevent="formSubmit">
                          ...
                          <ul class="list-inline m-0 p-0">
                             <li class="item mb-1">
                                <div class="d-flex align-items-center flex-wrap gap-1">
                                   ...
                                   <span v-if="EncounterDetails.user && EncounterDetails.user.first_name && EncounterDetails.user.last_name">
                                         {{ EncounterDetails.user.first_name }} {{ EncounterDetails.user.last_name }}
                                   </span>
                                </div>
                             </li>
                             <li class="item mb-1">
    ...
    <span v-if="EncounterDetails.user.cities && EncounterDetails.user.cities.name">
        , {{ EncounterDetails.user.cities.name }}
    </span>
    <span v-if="EncounterDetails.user.countries && EncounterDetails.user.countries.name">
        , {{ EncounterDetails.user.countries.name }}
    </span>
</span>
<span v-else>-</span>
                          ...
                          <ul class="list-inline mt-3 pt-3 mx-0 mb-0 pb-0 border-top">
                             ...
                             <li class="item mb-1">
                                <div class="d-flex align-items-center flex-wrap gap-1">
                                   ...
                                   <span v-if="EncounterDetails.doctor && EncounterDetails.doctor.first_name && EncounterDetails.doctor.last_name">
                                         {{ EncounterDetails.doctor.first_name }} {{ EncounterDetails.doctor.last_name }}
                                   </span>
                                </div>
                             </li>
                             <li class="item">
                       ...
                       <div class="d-flex justify-content-between flex-wrap gap-3 card-header mb-4">
                          ...
                          <div>
                             ...
                             <div class="d-flex flex-wrap gap-3">
                                ...
                                <button  v-if="enable_bodychart==1 && EncounterDetails.status==1" @click.prevent="bodychart()" class="btn btn-primary">
                             ...
                             <div class="col-lg-4 col-md-6" v-if="enableProblem">
                                <div class="card bg-body">
                                   ...
                                   <div class="card-footer border-top"  v-if=" EncounterDetails.status==1">
                                      ...
                                      <p class="mt-2 mb-0 fs-12 clinical_details_notes"><b>{{ $t('appointment.note_encounter_problem') }}</b></p>
                                   </div>
                                </div>
                             </div>
                             <div class="col-lg-4 col-md-6" v-if="enableobservation">
                                <div class="card bg-body">
                                   ...
                                   <div class="card-footer border-top"  v-if=" EncounterDetails.status==1">
                                      ...
                                      <p class="mt-2 mb-0 fs-12 clinical_details_notes"><b>{{$t('appointment.note_encounter_observation')}}</b></p>
                                   </div>
                                </div>
                             </div>
  ...
  const addOtherDetails=()=>{
    ...
    const SendPrescription=()=>{
     ...
     Mail_Sending.value=1;
      ...
      storeRequest({ url:SEND_PRESCRIPTION_URL, body: prescriptiondata }).then((res) => {reset_datatable_close_offcanvas(res) })
    ...
    const EmportFile=(value)=>{
     ...
     exportData.type =value,
       ...
       storeRequest({ url:EXPORT_PRESCRIPTION_URL, body: exportData }).then((res) => {reset_datatable_close_offcanvas(res) })
  ...
  const close_off_canvas =()=>{
   ...
   IS_SUBMITED.value = true
     ...
     storeRequest({ url:SAVE_ENCOUNTER_DETAILS, body: EncounterData }).then((res) => {reset_datatable_offcanvas(res) })
