 ...
 const appointment_id = ref();  
  ...
  if (newValue !== null) {
    console.log(newValue)
     clinic_id.value= newValue.clinic_id,
     doctor_id.value= newValue.doctor_id,
     user_id.value= newValue.user_id,
...
const getServiceDetails =() =>{
  ...
  const getServiceList = () => {
    service_id.value='',
    useSelect({ url: SERVICE_LIST, data: {doctor_id: doctor_id.value, clinic_id: clinic_id.value } }, { value: 'id', label: 'name' }).then((data) => (servicelist.value = data))
