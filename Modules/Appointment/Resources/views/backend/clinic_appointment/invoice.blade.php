                        ...
                        <div class="table-responsive">
                            <table class="table custom-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $index }}</td>
                                        <td>{{ $info['clinicservice']['systemservice']['name'] ?? '--' }}</td>
                        ...
                        <div class="table-responsive">
                            <table class="table custom-table">
                                ...
                                <tr>
                                    ...
                                    <th colspan="2" class="text-right">{{ Currency::format($total_amount) }}</th>
                                </tr>
                                @php
                                $amount_total = 0;
                                ...
                                <tfoot>
                                    ...
                                    @endif
                                        ...
                                        <th colspan="2" class="text-right">{{ Currency::format($discount_amount) ?? '--' }}</th>
                                    </tr>
                                    <tr>
                                        <th colspan="6" class="text-right">{{ __('messages.amount_due') }}</th>
                                        <th colspan="2" class="text-right">{{ Currency::format($amount_due) ?? '--' }}</th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
