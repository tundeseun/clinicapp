                        ...
                        <div class="d-flex align-items-center bg-body p-4 rounded">
                            ...
                            <div class="ms-3 w-100 d-flex align-items-center justify-content-between flex-wrap">
                                ...
                                <div class="d-flex align-items-center">
                                    <span><b>{{optional($appointment->clinicservice)->name}}</b> {{(optional($appointment->clinicservice)->description) ?? ' '}}</span>
                                </div>
                                <h5 class="mb-0 w-50 text-lg-end text-sm-start">{{ Currency::format($appointment->service_price) }}</h5>
                            </div>
                        </div>
