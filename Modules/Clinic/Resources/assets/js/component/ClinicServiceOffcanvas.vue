        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <Multiselect id="clinic_id" v-model="clinic_id" :placeholder="$t('clinic.singular_title')" :multiple="true" :value="clinic_id" v-bind="multiSelectOption" :options="clinic_centers.options" class="form-group"></Multiselect>
