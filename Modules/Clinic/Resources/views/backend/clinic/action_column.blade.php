<div class="d-flex gap-3 align-items-center">
 <button type='button' data-assign-module="{{$data->id}}" data-assign-target='#clinic-session-form' data-assign-event='clinic_session' class='btn text-primary p-0 fs-5' data-bs-toggle='tooltip' title='Session'><i class='ph ph-plus align-middle'></i></button>
