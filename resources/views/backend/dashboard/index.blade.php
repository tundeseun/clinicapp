    ...
    <div class="col-md-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex  align-items-center">
                ...
                <button type="submit" name="action" value="filter" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-title="{{ __('messages.submit_date_filter') }}">{{ __('dashboard.lbl_submit') }}</button>
                </form> --}}
                ...
                <div class="table-responsive rounded bg-body">
                    <table class="table border m-0">
                        ...
                        <tbody id="payment_history_table_body">
                            ...
                            @empty
                            <tr>
                                <td class="text-center" colspan="3">{{ __('messages.payment_history_notavailable') }}
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
